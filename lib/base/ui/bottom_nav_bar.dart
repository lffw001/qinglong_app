...
///
/// {@tool dartpad}
/// This example shows a [BottomNavigationBar2] as it is used within a [Scaffold]
/// widget. The [BottomNavigationBar2] has three [BottomNavigationBarItem]
...
/// {@tool dartpad}
/// This example shows a [BottomNavigationBar2] as it is used within a [Scaffold]
/// widget. The [BottomNavigationBar2] has four [BottomNavigationBarItem]
...
/// also defined, which changes the background color of [BottomNavigationBar2],
...
class BottomNavigationBar2 extends StatefulWidget {
  ...
  /// The z-coordinate of this [BottomNavigationBar2].
  ///
  ...
  /// Defines the layout and behavior of a [BottomNavigationBar2].
  ///
  ...
  /// The color of the [BottomNavigationBar2] itself.
  ///
...
class _Tile extends StatelessWidget {
  const _Tile({Key? key, required this.layout, required this.icon, required this.label}) : super(key: key);
...
class _BottomNavigationBar2State extends State<BottomNavigationBar2> with TickerProviderStateMixin {
  ...
  void _resetState() {
    for (final AnimationController controller in _controllers) controller.dispose();
  ...
  @override
  void didUpdateWidget(BottomNavigationBar2 oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final BottomNavigationBarThemeData bottomTheme = BottomNavigationBarTheme.of(context);
    final BottomNavigationBarLandscapeLayout layout = widget.landscapeLayout ?? bottomTheme.landscapeLayout ?? BottomNavigationBarLandscapeLayout.spread;
...
class _Circle {
  ...
  final _BottomNavigationBar2State state;
  final int index;
  final Color color;
