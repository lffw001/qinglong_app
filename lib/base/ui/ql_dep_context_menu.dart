...
///
/// When open, the [QlDepCupertinoContextMenu] shows the child, or the widget returned
...
class QlDepCupertinoContextMenu extends StatefulWidget {
  ...
  /// The widget that can be "opened" with the [QlDepCupertinoContextMenu].
  ///
  /// When the [QlDepCupertinoContextMenu] is long-pressed, the menu will open and
  ...
  /// doesn't size itself.
  ///
  /// When the [QlDepCupertinoContextMenu] is "closed", this widget acts like a
  ...
  /// [QlDepCupertinoContextMenu] is open.
  ///
  ...
  @override
  State<QlDepCupertinoContextMenu> createState() =>
      _QlDepCupertinoContextMenuState();
}

class _QlDepCupertinoContextMenuState extends State<QlDepCupertinoContextMenu>
  ...
  void _openContextMenu() {
    ...
    Navigator.of(context).push<void>(_route!);
